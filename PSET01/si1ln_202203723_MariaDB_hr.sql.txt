...
ALTER TABLE regioes COMMENT 'Tabela de regioes';
...
ALTER TABLE paises COMMENT 'Tabela de paises de cada regiao';
...
ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'localizacoes id';
...
ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'localizacoes id';
...
ALTER TABLE cargos COMMENT 'Tabela Cargos do funcionario';
...
ALTER TABLE empregados  MODIFY COLUMN Id_supervisor INTEGER COMMENT 'Id_supervisor';
...
ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'data_inicial';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'Id do empregado';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'data final';
